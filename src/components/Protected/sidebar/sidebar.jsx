        ...
        <nav>
          ...
          <div className=''>
            ...
            <div className={`${styles.nav_item_list} ${drawer ? "" : styles.closed_drawer_nav_items} d-lg-block d-flex justify-content-between`}>
              ...
              <NavLink to='/announcement' style={side_bar_item_style} className={({ isActive }) => `${isActive ? styles.active_side_menu : ''} ${styles.side_bar_item} d-flex align-items-baseline mt-lg-4`}>
                <i className="fa-regular fa-bullhorn"></i>
                <h5 className='ms-1' style={{ display: drawer ? "" : "none" }}>Announcement</h5>
              </NavLink>
              <NavLink to='/events' style={side_bar_item_style} className={({ isActive }) => `${isActive ? styles.active_side_menu : ''} ${styles.side_bar_item} d-flex align-items-baseline mt-lg-4`}>
